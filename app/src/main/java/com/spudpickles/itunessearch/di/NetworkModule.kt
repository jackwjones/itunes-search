...
import com.spudpickles.itunessearch.network.*
import com.spudpickles.itunessearch.network.api.ITunesApiService
import com.spudpickles.itunessearch.network.interceptor.ErrorHandlingInterceptor
import com.spudpickles.itunessearch.network.interceptor.HeadersInterceptor
import com.spudpickles.itunessearch.network.interceptor.LogJsonInterceptor
import com.spudpickles.itunessearch.network.interceptor.LogRequestBodyInterceptor
...
class NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideITunesApi(@Named(RETROFIT_MAIN) retrofit: Retrofit): ITunesApiService =
        retrofit.create(ITunesApiService::class.java)

    @Provides
    @Singleton
    fun provideITunesApiExecutor(
        api: ITunesApiService,
        errorHandler: ErrorHandler
    ): NetworkExecutor<ITunesApiService> = NetworkExecutor(api, errorHandler)
